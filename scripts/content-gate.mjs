...
// outside the price guide, no competitor names, banned phrases, FAQ count,
...
for (const file of process.argv.slice(2)) {
  ...
  if (base === PRICE_GUIDE && !draft) errors.push("price guide must be draft: true until the client approves");
